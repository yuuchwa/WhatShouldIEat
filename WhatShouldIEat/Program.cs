...
namespace WhatShouldIEat
{
    internal static class Program
    {
        public static void Main(string[] args)
        {
            ...
            description.AddLayer<HumanGridLayer>(); // we'll use a simple grid layer here
            description.AddAgent<Model.HumanAgent, HumanGridLayer>(); // the agent type will be located at the grid layer
